...
export function getGamesData(): IGames[] {
    let gamesStr = fs.readFileSync('games.json', 'utf-8');
    let games = JSON.parse(gamesStr);
    return games;
}

export function getCategories(games: IGames[]): Set<any[]> {
    let arr: any[] = [];
...
export function getAuthors(games: IGames[]): Set<any[]> {
    let arr: any[] = [];
    games.forEach( ({caracteristic}) => {
...
export function getMecanisms(games: IGames[]): Set<any[]> {
    let arr: any[] = [];
    games.forEach( ({caracteristic}) => {
...
export function getContents(games: IGames[]): any[] {
    return games.map(game => ({contents: game.contents, game_name: removeDiacritics(game.name)}));
}

export function getEditors(games: IGames[]): Set<any[]> {
    let arr: any[] = [];
    games.forEach( ({caracteristic}) => {
...
export function getBrandsList(games: IGames[]): any[] {
    return [...new Set(games.map(({brand}) => brand))];
}

export function getPictures(games: IGames[]): any[] {
    return games.map(game => {
        return {game_name: game.name, pics: game.pics};
    });
}

export function getLanguages(games: IGames[]): Set<any[]> {
    let arr: any[] = [];
    games.forEach( ({caracteristic}) => {
